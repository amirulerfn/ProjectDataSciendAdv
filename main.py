...
# Additional spacing to separate sections visually
st.markdown(""" 
    ---
    ### **How it Works:**
    - Explore dynamic insights and visualizations of the egg distribution process across Kelantan.
    - Predict future egg prices based on historical data and market trends.
    - Visualize the effects of supply and demand changes in different regions of Kelantan.
""")
